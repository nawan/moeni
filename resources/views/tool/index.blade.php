    ...
    <div class="card mt-10 mb-5">
        ...
        <div class="card-body">
            <div class="d-flex mt-4 mb-3">
                <a href="{{ route('bahan.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i> Tambah Data Bahan</a>
            </div>
            <table class="table table-bordered table-hover text-center align-middle stripe" id="data-bahan">
